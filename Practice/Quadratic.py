...
plot_regression(n, table[1], degree, "Selection Sort Data", "Selection Sort Curve", "blue")
plot_regression(n, table[2], degree, "Insertion Sort Data", "Insertion Sort Curve", "red")
plot_regression(n, table[3], degree, "Bubble Sort Data", "Bubble Sort Curve", "black")
plot_regression(n, table[6], degree, "Shell Sort (Shell) Data", "Shell Sort (Shell) Curve", "cyan")
plot_regression(n, table[7], degree, "Shell Sort (Hibbard) Data", "Shell Sort (Hibbard) Curve", "magenta")
plt.xlabel('n')
plt.ylabel('T(n)')
plt.title("Квадратичная асимптотика")
plt.legend()
plt.grid(True)
plt.show()
